...
# 11 "ECU_Layer/LCD/ecu_chr_lcd.c"
...
# 11 "ECU_Layer/LCD/ecu_chr_lcd.c" 2
...
static Std_ReturnType lcd_4bit_set_cursor(const lcd_chr_4bit_t * _lcd , uint8 row , uint8 column){
    ...
    column--;
    switch(row){
        case 1: ret = lcd_4bit_send_command(_lcd , (0x80 + column));
        break;
        case 2: ret = lcd_4bit_send_command(_lcd , (0xc0 + column));
        break;
        case 3: ret = lcd_4bit_send_command(_lcd , (0x94 + column));
        break;
        case 4: ret = lcd_4bit_send_command(_lcd , (0xd4 + column));
        break;
        default: ;
...
static Std_ReturnType lcd_8bit_set_cursor(const lcd_chr_8bit_t * _lcd , uint8 row , uint8 column){
    ...
    column--;
    switch(row){
        case 1: ret = lcd_8bit_send_command(_lcd , (0x80 + column));
        break;
        case 2: ret = lcd_8bit_send_command(_lcd , (0xc0 + column));
        break;
        case 3: ret = lcd_8bit_send_command(_lcd , (0x94 + column));
        break;
        case 4: ret = lcd_8bit_send_command(_lcd , (0xd4 + column));
        break;
        default: ;
