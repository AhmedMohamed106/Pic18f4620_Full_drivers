...
# 12 "MCAL_Layer/ADC/hal_adc_cfg.h"
...
# 12 "MCAL_Layer/ADC/hal_adc_cfg.h" 2
...
# 61 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void (*Interrupt_handler)(void) = ((void*)0);

static __attribute__((inline)) void adc_input_channel_port_configure(const adc_channel_Select_t _channel);
static __attribute__((inline)) void adc_select_format_configure(const adc_config_t * _adc);
static __attribute__((inline)) void adc_voltage_reference_configure(const adc_config_t * _adc);
...
Std_ReturnType ADC_GetConversionResult(const adc_config_t *_adc , adc_result_t *Conversion_result){
    ...
    else
    {
        ...
        if(0x01U == _adc->format_select)
        {
            *Conversion_result = (adc_result_t)((ADRESH << 8) + ADRES);

        }
        else if(0x00U == _adc->format_select)
        {
...
static __attribute__((inline)) void adc_input_channel_port_configure(const adc_channel_Select_t _channel){
    ...
    switch(_channel){
        ...
        case ADC_CHANNEL_AN0:
            (TRISA |= ((uint8)1 << 0x0)); break;
        case ADC_CHANNEL_AN1:
            (TRISA |= ((uint8)1 << 0x1)); break;
        case ADC_CHANNEL_AN2:
            (TRISA |= ((uint8)1 << 0x2)); break;
        case ADC_CHANNEL_AN3:
            (TRISA |= ((uint8)1 << 0x3)); break;
        case ADC_CHANNEL_AN4:
            (TRISA |= ((uint8)1 << 0x5)); break;
        case ADC_CHANNEL_AN5:
            (TRISE |= ((uint8)1 << 0x0)); break;
        case ADC_CHANNEL_AN6:
            (TRISE |= ((uint8)1 << 0x1)); break;
        case ADC_CHANNEL_AN7:
            (TRISE |= ((uint8)1 << 0x2)); break;
        case ADC_CHANNEL_AN8:
            (TRISB |= ((uint8)1 << 0x2)); break;
        case ADC_CHANNEL_AN9:
            (TRISB |= ((uint8)1 << 0x3)); break;
        case ADC_CHANNEL_AN10:
            (TRISB |= ((uint8)1 << 0x1)); break;
        case ADC_CHANNEL_AN11:
            (TRISB |= ((uint8)1 << 0x4)); break;
        case ADC_CHANNEL_AN12:
            (TRISB |= ((uint8)1 << 0x0)); break;
        default: { };
