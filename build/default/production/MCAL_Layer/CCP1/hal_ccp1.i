...
# 13 "MCAL_Layer/CCP1/../Interrupt/mcal_internal_interrupt.h"
...
# 1 "MCAL_Layer/CCP1/../Interrupt/../device_config.h" 1
# 15 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h" 2

# 1 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 16 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h" 2

# 1 "MCAL_Layer/CCP1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 16 "MCAL_Layer/CCP1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/CCP1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_Layer/CCP1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/CCP1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 17 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h" 2
# 61 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 1 "MCAL_Layer/CCP1/../Timer2/hal_timer2.h" 1
# 33 "MCAL_Layer/CCP1/../Timer2/hal_timer2.h"
typedef enum {
...
static void (*CCP1InterruptHandler) (void) = ((void*)0);
...
# 86 "MCAL_Layer/CCP1/hal_ccp1.c"
        ...
        else if(CCP1_PWM_MODE_SELECTED == _ccp1->ccp1_mode)
        {
            ...
            if(((uint8)0x0C) == _ccp1->ccp1_mode)

                (CCP1CONbits.CCP1M = ((uint8)0x0C));
            else { }

            PR2 = (uint8)(((8000000UL)/ ((_ccp1->PWM_Frequency) * (4.0) * (_ccp1->Postscale_value)
...
# 129 "MCAL_Layer/CCP1/hal_ccp1.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 267 "MCAL_Layer/CCP1/hal_ccp1.c"
Std_ReturnType CCP1_PWM_Set_Duty(const uint8 _duty){
