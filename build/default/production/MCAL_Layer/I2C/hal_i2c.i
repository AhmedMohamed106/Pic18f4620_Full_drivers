...
static void (* MSSP_I2cMaster_receiver_overflow ) (void) = ((void*)0);

static void (* MSSP_I2cMasterInterruptHandler ) (void) = ((void*)0);

static void (* MSSP_i2c_report_write_collision ) (void) = ((void*)0);




static void __attribute__((inline)) Master_Mode_Clk_Configuration(const mssp_i2c_t * i2c_obj);
static void __attribute__((inline)) MSSP_I2c_Interrupt_Configuration(const mssp_i2c_t * i2c_obj);
...
Std_ReturnType MSSP_I2c_Master_Read_Blocking(const mssp_i2c_t * i2c_obj ,uint8 ack ,uint8 * i2c_Value){
    ...
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) == i2c_obj || ((void*)0) == i2c_Value)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static void __attribute__((inline)) Master_Mode_Clk_Configuration(const mssp_i2c_t * i2c_obj){
    ...
    SSPCON1bits.SSPM = i2c_obj->i2c_cfg.i2c_mode_cfg;
    SSPADD = (uint8)((8000000UL / (4.0 * (i2c_obj->i2c_clk))) - 1);
}
static void __attribute__((inline)) MSSP_I2c_Interrupt_Configuration(const mssp_i2c_t * i2c_obj){
