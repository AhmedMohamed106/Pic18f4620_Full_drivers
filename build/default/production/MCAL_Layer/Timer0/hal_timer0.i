...
# 1 "MCAL_Layer/Timer0/../Interrupt/../device_config.h" 1
...
# 16 "MCAL_Layer/Timer0/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer0/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_Layer/Timer0/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/Timer0/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 61 "MCAL_Layer/Timer0/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void (*Timer0InterruptHandler) (void) = ((void*)0);
...
# 27 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Init(const timer0_config_t *_timer){
...
static __attribute__((inline)) void Timer0_Prescaler_Config(const timer0_config_t * _timer){
    if(0x01U == _timer->prescaler_enable)
    {
        (T0CONbits.PSA = 0);
        T0CONbits.T0PS = _timer->Prescale_value;
    }
    else if(0x00U == _timer->prescaler_enable)
    {
        (T0CONbits.PSA = 1);
    }
    else { }
...
static __attribute__((inline)) void Timer0_Register_Size_Config(const timer0_config_t * _timer){
    if(0x01U == _timer->timer0_Register_mode)
    {
        (T0CONbits.T08BIT = 1);
    }
    else if(0x01U == _timer->timer0_Register_mode)
    {
        (T0CONbits.T08BIT = 0);
    }
    else { }
...
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_config_t * _timer){
  if(0x01U == _timer->timer_counter_mode)
    {
        (T0CONbits.T0CS = 0);
    }
    else if(0x00U == _timer->timer_counter_mode)
    {
        (T0CONbits.T0CS = 1);
        if(0x01U == _timer->edge_select)
        {
            (T0CONbits.T0SE = 0);
        }
        else if (0x00U == _timer->edge_select)
        {
            (T0CONbits.T0SE = 1);
        }
