...
# 16 "MCAL_Layer/Timer1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_Layer/Timer1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/Timer1/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 61 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void (*Timer1InterruptHandler) (void) = ((void*)0);

static uint16 timer1_preload = 0;

static __attribute__((inline)) void Timer1_Prescaler_Config(const timer1_config_t * _timer);
static __attribute__((inline)) void Timer1_Register_Size_Config(const timer1_config_t * _timer);
static __attribute__((inline)) void Timer1_Mode_Select(const timer1_config_t * _timer);
# 27 "MCAL_Layer/Timer1/hal_timer1.c"
Std_ReturnType Timer1_Init(const timer1_config_t *_timer){
...
static __attribute__((inline)) void Timer1_Mode_Select(const timer1_config_t * _timer){
  if(0x00U == _timer->timer1_mode)
    {
        (T1CONbits.TMR1CS = 0);
    }
    else if(0x01U == _timer->timer1_mode)
    {
        (T1CONbits.TMR1CS = 1);
        if(0x01U == _timer->timer1_counter_mode)
        {
            (T1CONbits.T1SYNC = 1);
        }
        else if (0x00U == _timer->timer1_counter_mode)
        {
            (T1CONbits.T1SYNC = 0);
        }
...
static __attribute__((inline)) void Timer1_Register_Size_Config(const timer1_config_t * _timer)
{
    if(0x01U == _timer->timer1_re_wr_mode)
    {
        (T1CONbits.RD16 = 1);
    }
    else if (0x00U == _timer->timer1_re_wr_mode)
    {
        (T1CONbits.RD16 = 0);
    }
    else
