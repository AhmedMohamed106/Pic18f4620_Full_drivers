...
# 16 "MCAL_Layer/Timer3/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer3/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_Layer/Timer3/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/Timer3/../Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 61 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void (*Timer3InterruptHandler) (void) = ((void*)0);

static uint16 timer3_preload = 0;

static __attribute__((inline)) void Timer3_Prescaler_Config(const timer3_config_t * _timer);
static __attribute__((inline)) void Timer3_Register_Size_Config(const timer3_config_t * _timer);
static __attribute__((inline)) void Timer3_Mode_Select(const timer3_config_t * _timer);
# 27 "MCAL_Layer/Timer3/hal_timer3.c"
Std_ReturnType Timer3_Init(const timer3_config_t *_timer){
...
static __attribute__((inline)) void Timer3_Mode_Select(const timer3_config_t * _timer){
  if(0x00U == _timer->timer3_mode)
    {
        (T3CONbits.TMR3CS = 0);
    }
    else if(0x01U == _timer->timer3_mode)
    {
        (T3CONbits.TMR3CS = 1);
        if(0x01U == _timer->timer3_counter_mode)
        {
            (T3CONbits.T3SYNC = 1);
        }
        else if (0x00U == _timer->timer3_counter_mode)
        {
            (T3CONbits.T3SYNC = 0);
        }
...
static __attribute__((inline)) void Timer3_Register_Size_Config(const timer3_config_t * _timer)
{
    if(0x01U == _timer->timer3_re_wr_mode)
    {
        (T3CONbits.RD16 = 1);
    }
    else if (0x00U == _timer->timer3_re_wr_mode)
    {
        (T3CONbits.RD16 = 0);
    }
    else
