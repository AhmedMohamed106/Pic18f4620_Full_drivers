...
# 44 "./ECU_Layer/Relay/ecu_relay.h"
...
# 26 "./ECU_Layer/Seven_segment/ecu_seven_seg.h"
typedef enum {
...
# 77 "./MCAL_Layer/Timer0/hal_timer0.h"
typedef enum {
...
# 84 "./MCAL_Layer/Timer1/hal_timer1.h"
typedef enum {
...
# 83 "./MCAL_Layer/Timer3/hal_timer3.h"
typedef enum {
...
# 160 "./MCAL_Layer/CCP1/hal_ccp1.h"
...
# 150 "./MCAL_Layer/Usart/hal_usart.h"
typedef enum {
...
typedef struct {
    ...
    void (* Master_receiver_overflow)(void);
...
uint8 ack_bit;
volatile uint8 i2c_value2 , rec_data;


led_t led1 = {.led_status = GPIO_LOW ,.port_name = PORTD_INDEX, .pin = GPIO_PIN0 };

void DefautInterruptHandler(void){
...
mssp_i2c_t i2c_obj = {
.i2c_cfg.i2c_mode = 0,
.i2c_cfg.i2c_mode_cfg = 0x06,
.i2c_cfg.i2c_slew_rate = 1,
.i2c_cfg.i2c_SMBus_Control = 0,
.i2c_cfg.i2c_general_call = 0,
.i2c_slave_Address = 0x60,
.Default_InterruptHandler = DefautInterruptHandler,
.Master_receiver_overflow = ((void*)0),
